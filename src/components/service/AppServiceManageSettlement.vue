<template>
  <div class="app-service-mgt-settlement">
    ...
    <div class="settlement">
      <el-radio-group v-model="settlementChoosing">
        <el-radio :label="1">
...
export default {
  ...
  computed: {
    ...
    settlementType: {
      get() {
        console.log(
          this.$store.state.merchantProfile.merchantSettlementConfigVo
        );
        if (this.$store.state.merchantProfile.merchantSettlementConfigVo) {
          return this.$store.state.merchantProfile.merchantSettlementConfigVo
            .settlementType;
        } else {
    ...
    handleSaveSettlement() {
      this.$api
        .updateMerchantSettlement({
          ...
          settlementType: this.settlementChoosing
        })
        .then(res => {
